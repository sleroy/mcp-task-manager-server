...
export const TOOL_PARAMS = z.object({
  project_id: z
    ...
    .describe(
      "The unique identifier (UUID) of the project that owns the sprint."
    ),
  name: z
    .string()
  ...
  goal: z
    .string()
    .max(1024, "Sprint goal cannot exceed 1024 characters.")
    .nullable()
    .optional()
    .describe("Optional sprint goal."),
  description: z
    .string()
    .max(1024, "Sprint description cannot exceed 1024 characters.")
    .nullable()
    .optional()
    .describe(
      "Optional alias for sprint goal, accepted for clients that use description."
    ),
  milestone: z
    .string()
    .min(1)

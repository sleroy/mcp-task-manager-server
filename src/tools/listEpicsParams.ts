...
export const TOOL_PARAMS = z.object({
  project_id: z
    ...
    .describe(
      "The unique identifier (UUID) of the project whose epics should be listed."
    ),
  status: TaskStatusEnum.optional().describe(
    "Optional filter to return only epics with this status."
  ),
  milestone: z
    .string()
    .min(1)
  ...
  include_subtasks: z
    ...
    .default(true)
    .describe(
      "Optional flag to include nested stories and tasks. Defaults to true."
    ),
});
